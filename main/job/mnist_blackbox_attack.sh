...
#SBATCH --workdir= .
#SBATCH --job-name=mnist_scd_attack
...
#python bb_attack.py --epsilon 0.2 --Lambda 0.1 --gpu $gpu --epoch 20 --aug-epoch 20 --lr 0.001 --n_classes 10 \
#--train-size 200 --target mnist_scd01mlp_32_br02_nr075_ni500_i1 --random-sign 1 --seed $seed --dataset mnist --oracle-size 1024 --n_classes 10

#python bb_attack.py --epsilon 0.2 --Lambda 0.1 --gpu $gpu --epoch 20 --aug-epoch 20 --lr 0.001 --n_classes 10 \
#--train-size 200 --target mnist_scd01mlp_32_br05_nr075_ni500_i1 --random-sign 1 --seed $seed --dataset mnist --oracle-size 1024 --n_classes 10
#
python bb_attack.py --epsilon 0.2 --Lambda 0.1 --gpu $gpu --epoch 20 --aug-epoch 20 --lr 0.001 --n_classes 10 \
